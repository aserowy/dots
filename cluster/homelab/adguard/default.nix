...
in
{
  applications.adguard = {
    ...
    resources = {
          ...
          template = {
            ...
            spec = {
              ...
              containers = [
                {
                  name = "adguard";
                  image = "docker.io/adguard/adguardhome:v0.107.73"; # docker/adguard/adguardhome@semver
                  securityContext = {
                    allowPrivilegeEscalation = false;
                    readOnlyRootFilesystem = true;
                  };
      ...
      configMaps.adguard-cm = {
        metadata = {
          inherit namespace;
          name = "adguard-cm";
        };
        data."adguardhome.yaml" = (builtins.readFile ./adguard-config.yaml);
      };
      ...
      ciliumNetworkPolicies.adguard = {
        ...
        spec = {
          endpointSelector.matchLabels."app.kubernetes.io/name" = "adguard";
          ingress = [
            {
              fromEndpoints = [
                {
