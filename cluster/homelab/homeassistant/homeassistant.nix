          ...
          template = {
            ...
            spec = {
              initContainers = [
                {
                  ...
                  image = "mikefarah/yq:4.52.2"; # docker/mikefarah/yq@semver-coerced
                  securityContext = {
              ...
              containers = [
                {
                  name = "homeassistant";
                  image = "homeassistant/home-assistant:2026.2.1"; # docker/homeassistant/home-assistant@semver-coerced
                  securityContext = {
                    allowPrivilegeEscalation = false;
                    capabilities = {
                      drop = [ "ALL" ];
