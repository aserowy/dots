            ...
            template = {
              ...
              spec = {
                initContainers = [
                  {
                    ...
                    image = "mikefarah/yq:4.49.2"; # docker/mikefarah/yq@semver-coerced
                    securityContext = {
                  ...
                  {
                    name = "setup-hacs";
                    image = "bash:5.3.8"; # docker/bash@semver-coerced
                    securityContext = {
                      allowPrivilegeEscalation = false;
                      readOnlyRootFilesystem = true;
                      capabilities = {
                ...
                containers = [
                  {
                    name = "homeassistant";
                    image = "homeassistant/home-assistant:2025.12.2"; # docker/homeassistant/home-assistant@semver-coerced
                    securityContext = {
                      allowPrivilegeEscalation = false;
                      capabilities = {
                        drop = [ "ALL" ];
