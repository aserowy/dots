            ...
            template = {
              ...
              spec = {
                initContainers = [
                  {
                    ...
                    image = "mikefarah/yq:4.47.2"; # docker/mikefarah/yq@semver-coerced
                    securityContext = {
                ...
                containers = [
                  {
                    name = "homeassistant";
                    image = "homeassistant/home-assistant:2025.9.3"; # docker/homeassistant/home-assistant@semver-coerced
                    securityContext = {
                      allowPrivilegeEscalation = false;
                      capabilities = {
                        drop = [ "ALL" ];
