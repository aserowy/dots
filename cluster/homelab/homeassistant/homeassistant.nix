            ...
            template = {
              ...
              spec = {
                initContainers = [
                  {
                    ...
                    image = "mikefarah/yq:4.48.1"; # docker/mikefarah/yq@semver-coerced
                    securityContext = {
                ...
                containers = [
                  {
                    name = "homeassistant";
                    image = "homeassistant/home-assistant:2025.10.4"; # docker/homeassistant/home-assistant@semver-coerced
                    securityContext = {
                      allowPrivilegeEscalation = false;
                      capabilities = {
                        drop = [ "ALL" ];
