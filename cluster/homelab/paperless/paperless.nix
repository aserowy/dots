          ...
          template = {
            ...
            spec = {
              ...
              containers = [
                {
                  name = "paperless";
                  image = "docker.io/paperlessngx/paperless-ngx:2.20.10"; # docker/paperlessngx/paperless-ngx@semver-coerced
                  securityContext = {
          ...
          jobTemplate.spec.template = {
            ...
            spec = {
              ...
              containers = [
                {
                  name = "rclone-move";
                  image = "rclone/rclone:1.73.1"; # docker/rclone/rclone@semver-coerced
