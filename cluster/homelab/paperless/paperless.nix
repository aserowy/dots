          ...
          template = {
            ...
            spec = {
              ...
              containers = [
                {
                  name = "paperless";
                  image = "docker.io/paperlessngx/paperless-ngx:2.20.15"; # docker/paperlessngx/paperless-ngx@semver-coerced
                  securityContext = {
          ...
          jobTemplate.spec.template = {
            ...
            spec = {
              ...
              containers = [
                {
                  name = "rclone-move";
                  image = "rclone/rclone:1.73.5"; # docker/rclone/rclone@semver-coerced
