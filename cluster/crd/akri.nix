  ...
  definitions = {
    ...
    "akri.sh.v0.ConfigurationSpecDiscoveryHandler" = {
      options = {
        ...
        "discoveryProperties" = mkOption {
          description = "";
          type = types.nullOr (coerceAttrsOfSubmodulesToListByKey "akri.sh.v0.ConfigurationSpecDiscoveryHandlerDiscoveryProperties" "name" []);
          apply = attrsToList;
        };
        "name" = mkOption {
          description = "";
    ...
    "akri.sh.v0.ConfigurationSpecDiscoveryHandlerDiscoveryProperties" = {
      options = {
        ...
        "valueFrom" = mkOption {
          description = "";
          type = types.nullOr (submoduleOf "akri.sh.v0.ConfigurationSpecDiscoveryHandlerDiscoveryPropertiesValueFrom");
        };
      };
    ...
    "akri.sh.v0.ConfigurationSpecDiscoveryHandlerDiscoveryPropertiesValueFrom" = {
      options = {
        "configMapKeyRef" = mkOption {
          description = "";
          type = types.nullOr (submoduleOf "akri.sh.v0.ConfigurationSpecDiscoveryHandlerDiscoveryPropertiesValueFromConfigMapKeyRef");
        };
        "secretKeyRef" = mkOption {
          description = "";
          type = types.nullOr (submoduleOf "akri.sh.v0.ConfigurationSpecDiscoveryHandlerDiscoveryPropertiesValueFromSecretKeyRef");
        };
      };
...
in {
    ...
    resources =
      {
        "akri.sh"."v0"."Configuration" = mkOption {
          description = "";
          type = types.attrsOf (submoduleForDefinition "akri.sh.v0.Configuration" "configurations" "Configuration" "akri.sh" "v0");
          default = {};
        };
        "akri.sh"."v0"."Instance" = mkOption {
          description = "Auto-generated derived type for InstanceSpec via `CustomResource`";
          type = types.attrsOf (submoduleForDefinition "akri.sh.v0.Instance" "instances" "Instance" "akri.sh" "v0");
          default = {};
        };
      }
      // {
  ...
  config = {
    ...
    resources = {
      ...
      "akri.sh"."v0"."Instance" =
        mkAliasDefinitions options.resources."instances";
    };
