...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  vscode-extensions-remote-containers = {
    ...
    version = "0.349.0";
    src = fetchurl {
      url = "https://ms-vscode-remote.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode-remote/extension/remote-containers/0.349.0/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "remote-containers-0.349.0.zip";
  ...
  vscode-extensions-vscode-neovim = {
    ...
    version = "1.7.0";
    src = fetchurl {
      url = "https://asvetliakov.gallery.vsassets.io/_apis/public/gallery/publisher/asvetliakov/extension/vscode-neovim/1.7.0/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "vscode-neovim-1.7.0.zip";
      sha256 = "sha256-GfNDs6qRf8EC1c02+SrHGMoI7kbzFoBo8bluXmfWmN8=";
    };
