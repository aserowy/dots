...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  vscode-extensions-errorlens = {
    ...
    version = "3.11.0";
    src = fetchurl {
      url = "https://usernamehw.gallery.vsassets.io/_apis/public/gallery/publisher/usernamehw/extension/errorlens/3.11.0/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "errorlens-3.11.0.zip";
      sha256 = "sha256-dOIjRCoBUHEPhSteFVC1XhAeKYnBKDBgjX1Ju4EmuIM=";
    };
    name = "errorlens";
  ...
  vscode-extensions-remote-wsl = {
    ...
    version = "0.79.3";
    src = fetchurl {
      url = "https://ms-vscode-remote.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode-remote/extension/remote-wsl/0.79.3/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "remote-wsl-0.79.3.zip";
      sha256 = "sha256-ASSWbT24RLErwl0JfHHOUC/ggBn0z15ZOyqUqRZMn/c=";
    };
    name = "remote-wsl";
    publisher = "ms-vscode-remote";
  };
