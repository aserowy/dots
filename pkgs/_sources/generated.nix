...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  vscode-extensions-remote-containers = {
    ...
    version = "0.365.0";
    src = fetchurl {
      url = "https://ms-vscode-remote.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode-remote/extension/remote-containers/0.365.0/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "remote-containers-0.365.0.zip";
      sha256 = "sha256-80wvGHVRsd92vMiaq9i9m1hEIcOKiEL0h2GVHKk9qWg=";
    };
  ...
  vscode-extensions-vscode-neovim = {
    ...
    version = "1.11.3";
    src = fetchurl {
      url = "https://asvetliakov.gallery.vsassets.io/_apis/public/gallery/publisher/asvetliakov/extension/vscode-neovim/1.11.3/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "vscode-neovim-1.11.3.zip";
      sha256 = "sha256-eGrPzdlmpwI2TkHVy3QwlVncnJJ9FxQCVx/lTQZ1Pe4=";
    };
