...
{ fetchgit, fetchurl }:
{
  ...
  microsoft-edge-beta = {
    ...
    src = fetchurl {
      ...
      sha256 = "0q014da2q2lrqqxcqsfjd5wc71sig816ym57d4xa3gbixj2nxgda";
    };
  };
  picom = {
    pname = "picom";
  ...
  spicetify-themes = {
    ...
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "0ngb1a6d9lv5i1g9v76az9z13rx1wiak7g6cpc2yzzzds6a9v779";
    };
  };
  tmux-continuum = {
  ...
  vscode-extensions-remote-containers = {
    ...
    version = "0.229.0";
    src = fetchurl {
      url = "https://ms-vscode-remote.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode-remote/extension/remote-containers/0.229.0/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      sha256 = "1hnc0rql7a8j74rci3im26sx4m7ccqdcdr5y9c9hrfbsh7fzhbn6";
    };
