...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  vscode-extensions-live-share = {
    ...
    version = "1.0.5667";
    src = fetchurl {
      url = "https://MS-vsliveshare.gallery.vsassets.io/_apis/public/gallery/publisher/MS-vsliveshare/extension/vsliveshare/1.0.5667/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "vsliveshare-1.0.5667.zip";
      sha256 = "sha256-sEa+pce9qja6vNuAf9DvLUmj4AWQvoTI8k5rOGTTIKc=";
    };
    name = "vsliveshare";
  ...
  vscode-extensions-vscode-icons = {
    ...
    version = "11.14.0";
    src = fetchurl {
      url = "https://vscode-icons-team.gallery.vsassets.io/_apis/public/gallery/publisher/vscode-icons-team/extension/vscode-icons/11.14.0/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "vscode-icons-11.14.0.zip";
      sha256 = "sha256-mS2prMfjqDfMvX/nGkd2Q7Xjwg0GwyENFpwl0yMgduk=";
    };
    name = "vscode-icons";
