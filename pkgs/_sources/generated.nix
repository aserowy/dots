...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  spicetify-cli = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v2.36.13";
      fetchSubmodules = false;
      sha256 = "sha256-0etyVzYL8F1GOAHEcpSfOoKe3GsGmAqVufVauqPDV1w=";
    };
  };
  spicetify-themes = {
  ...
  vscode-extensions-remote-containers = {
    ...
    version = "0.374.0";
    src = fetchurl {
      url = "https://ms-vscode-remote.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode-remote/extension/remote-containers/0.374.0/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "remote-containers-0.374.0.zip";
      sha256 = "sha256-cy2WOuh7b8yVIKjyo8kWYszcLpyTtdzCPwEbYI8ZWpY=";
    };
  ...
  vscode-extensions-vscode-neovim = {
    ...
    version = "1.17.2";
    src = fetchurl {
      url = "https://asvetliakov.gallery.vsassets.io/_apis/public/gallery/publisher/asvetliakov/extension/vscode-neovim/1.17.2/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "vscode-neovim-1.17.2.zip";
      sha256 = "sha256-IA09vUleY7hazu65kadES4iq3XojyJ3sXOOGaw0vJnU=";
    };
