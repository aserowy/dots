...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  spicetify-cli = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v2.20.3";
      fetchSubmodules = false;
      sha256 = "sha256-1Auvx2KZ97iD9EDm6QQdgS5YF9smw4dTvXF1IXtYrSI=";
    };
  };
  spicetify-themes = {
    pname = "spicetify-themes";
    version = "dec4b88039e846ca69d0fc67cd68823ea86aaa54";
    src = fetchFromGitHub {
      owner = "spicetify";
      repo = "spicetify-themes";
      rev = "dec4b88039e846ca69d0fc67cd68823ea86aaa54";
      fetchSubmodules = false;
      sha256 = "sha256-SRAFFWJz81VTu7/eesdVCV59ou6m4h/QIU3r+nqGGwg=";
    };
    date = "2023-07-15";
  };
  tmux-continuum = {
  ...
  vscode-extensions-vscode-neovim = {
    ...
    version = "0.3.2";
    src = fetchurl {
      url = "https://asvetliakov.gallery.vsassets.io/_apis/public/gallery/publisher/asvetliakov/extension/vscode-neovim/0.3.2/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "vscode-neovim-0.3.2.zip";
      sha256 = "sha256-kt9aUDYoMfNVKDS5IJkQ2SF5Nz96YcY345pu41aw+z4=";
    };
    name = "vscode-neovim";
